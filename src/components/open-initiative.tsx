          ...
          <div className="flex flex-col md:flex-row gap-8 items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="font-mono text-sm tracking-widest uppercase font-bold text-primary">Open Initiative</h2>
              </div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                I am building a VS Code extension that brings data structures to life — dynamic pointer arrows for Linked Lists, live tree renders, stack frames, and queue animations. All rendered in real-time as you code via WebView API and SVG rendering.
              </p>
            ...
            <div className="w-full md:w-1/3 flex flex-col gap-4 bg-background/50 border border-border/50 rounded-xl p-5 shrink-0">
              <div>
                <span className="text-xs font-mono text-muted-foreground uppercase tracking-widest block mb-2">Stack</span>
                <div className="flex flex-wrap gap-2">
                  <span className="px-2 py-1 text-[10px] font-mono bg-card border border-border/50 rounded text-foreground">TypeScript</span>
                  <span className="px-2 py-1 text-[10px] font-mono bg-card border border-border/50 rounded text-foreground">VS Code API</span>
                  <span className="px-2 py-1 text-[10px] font-mono bg-card border border-border/50 rounded text-foreground">SVG / Canvas</span>
                </div>
              </div>
              <div className="w-full h-[1px] bg-border/50 my-1" />
              <div>
                <span className="text-xs font-mono text-muted-foreground uppercase tracking-widest block mb-2">Ideal Ally</span>
