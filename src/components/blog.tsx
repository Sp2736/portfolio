...
const externalLogs = [
  {
    ...
    excerpt:
      "Two students may score the same marks in an exam, yet their actual understanding of the subject can be completely different.",
  ...
  },
  {
    ...
    excerpt:
      "In reality, a large portion of programming time is spent doing something far less glamorous but far more important: debugging.",
  ...
  },
  {
    ...
    excerpt:
      "The narrative sounds dramatic, but the reality is much more interesting.",
        ...
        <div className="lg:col-span-5 flex flex-col gap-8">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-6">
              I don't just write code; I write documentation, architecture
              breakdowns, and thoughts. Instead of building a static blog, I
              engineered a dedicated, scalable platform to house my
              transmissions.
            </p>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary/10 text-primary hover:bg-primary hover:text-primary-foreground transition-all font-mono text-sm font-semibold group"
            >
              Launch Platform{" "}
              <ExternalLink
                size={14}
