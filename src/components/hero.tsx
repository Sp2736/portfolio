...
export function Hero() {
  return (
    <section
      id="hero"
      className="relative w-full min-h-screen flex items-center justify-center px-6 pt-20 overflow-hidden"
    >
        ...
        <div className="flex flex-col gap-6 text-left p-8 rounded-3xl bg-background/40 backdrop-blur-md border border-border/50 shadow-2xl">
          ...
          >
            <h2 className="text-primary font-mono text-sm tracking-widest uppercase mb-3">
              Software Engineer | Full-Stack Architect | Author
            </h2>
          ...
          >
            ...
            engineering, AI, and thoughtful design. Computer Science student at
            Charusat University focused on scalable web systems and developer
            tools.
          </motion.p>
          <motion.div
